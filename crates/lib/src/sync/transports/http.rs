...
///
/// Note: This handler uses spawn_blocking with a LocalSet to handle non-Send futures
/// from SyncHandler. This is necessary because internal types use Rc/RefCell for
/// single-threaded performance, but axum requires Send futures.
async fn handle_sync_request(
    ...
    // (internal types use Rc/RefCell), but axum handlers require Send futures.
