...
fn test_entry_validation_with_corrupted_auth_section() {
    ...
    // Create a signed entry
    let mut entry =
        eidetica::entry::Entry::builder("root123".to_string(), "{}".to_string()).build();
    ...
    let empty_settings = eidetica::data::KVNested::new();
    ...
    let mut corrupted_settings = eidetica::data::KVNested::new();
    ...
    let mut deleted_settings = eidetica::data::KVNested::new();
    deleted_settings.set("auth", NestedValue::Deleted);
...
fn test_entry_validation_cache_behavior() {
    ...
    let mut settings = eidetica::data::KVNested::new();
    let mut auth_settings = eidetica::data::KVNested::new();
    ...
    let mut new_settings = eidetica::data::KVNested::new();
    let mut new_auth_settings = eidetica::data::KVNested::new();
...
fn test_entry_validation_with_malformed_keys() {
    ...
    let mut malformed_settings = eidetica::data::KVNested::new();
    let mut malformed_auth_settings = eidetica::data::KVNested::new();
    ...
    let mut wrong_signature_entry =
        eidetica::entry::Entry::builder("root456".to_string(), "{}".to_string()).build();
...
fn test_entry_validation_unsigned_entry_detection() {
    ...
    let entry = eidetica::entry::Entry::builder("root123".to_string(), "{}".to_string()).build();
    ...
    let mut settings = eidetica::data::KVNested::new();
    let auth_settings = eidetica::data::KVNested::new();
    settings.set_map("auth", auth_settings);
