...
fn test_transaction_with_custom_tips() {
    ...
    let op_b = ctx.database().new_transaction().unwrap();
    ...
    let op_c = ctx.database().new_transaction().unwrap();
...
fn test_transaction_multiple_subtrees_with_custom_tips() {
    ...
    let op_posts = ctx.database().new_transaction_with_tips([base_id]).unwrap();
...
fn test_transaction_custom_tips_subtree_in_ancestors_not_tips() {
    ...
    let settings4 = op4.get_store::<DocStore>("settings").unwrap();
...
fn test_transaction_custom_tips_no_subtree_data_in_tips() {
    ...
    let metadata4 = op4.get_store::<DocStore>("metadata").unwrap();
