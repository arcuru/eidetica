...
fn test_entry_id_determinism() {
    ...
    let mut builder1 = Entry::builder(ID::from_bytes("test_root"));
    builder1.set_parents_mut(vec![ID::from_bytes("parent1"), ID::from_bytes("parent2")]);
    builder1.set_subtree_data_mut("subtree1", "data1");
    builder1.set_subtree_data_mut("subtree2", "data2");
    builder1.set_subtree_parents_mut("subtree1", vec![ID::from_bytes("sub_parent1")]);
    let entry1 = builder1
        .build()
    ...
    let mut builder2 = Entry::builder(ID::from_bytes("test_root"));
    ...
    builder2.set_parents_mut(vec![ID::from_bytes("parent2"), ID::from_bytes("parent1")]);
    builder2.set_subtree_parents_mut("subtree1", vec![ID::from_bytes("sub_parent1")]);
    let entry2 = builder2
        .build()
        .expect("Entry should build successfully for determinism test");
    ...
    let mut builder3 = Entry::builder(ID::from_bytes("test_root"));
    builder3.set_parents_mut(vec![ID::from_bytes("parent2"), ID::from_bytes("parent1")]);
    builder3.set_subtree_data_mut("subtree2", "data2");
    builder3.set_subtree_data_mut("subtree1", "data1");
    builder3.set_subtree_parents_mut("subtree1", vec![ID::from_bytes("different_parent")]);
    let entry3 = builder3
        .build()
        .expect("Entry should build successfully for determinism test");
