...
- **Local Daemon Mode**: Share an Instance across processes via Unix socket RPC
...
- [Database Sharing](user_guide/database_management.md): Manage user intent and create point-in-time locators
